        ...
        for data_seed in range(loop):
            ...
            for model_seed in range(model_seeds):
                ...
                for epoch in range(args.epochs):
                    ...
                    elif args.model == "TransMIL" or args.model == "MMIL":    
                        print(f"Starting Training {epoch}")
...
parser.add_argument("--model", type=str, choices=["CLAM-SB","CLAM-MB","TransMIL", "MMIL"],default="CLAM-SB")
...
parser.add_argument('--num_subbags', default=32,type=int)
...
parser.add_argument('--num_msg', default=0,type=int)
parser.add_argument('--ape', default=False,type=bool)
