...
if __name__ == "__main__":
    ...
    for bag_idx in range(len(bags)):
        ...
        if flag == True:
            ...
            #patches_dataset = patches_dataset[100][0].squeeze()
            #patches_dataset = patches_dataset.permute(1, 2, 0)
            #patches_dataset = patches_dataset.numpy()
            #plt.imshow(patches_dataset, cmap = 'gray')
            #plt.show()
            #exit()
